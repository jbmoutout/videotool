"""Video export command for videotool using ffmpeg."""
...
<head>
    ...
    <title>VideoTool Export Preview</title>
    <style>
        body {
...
<body>
    <h1>VideoTool Export Preview</h1>
...
def export_video(project_path: Path, ffmpeg_path: str = "ffmpeg") -> Optional[Path]:
    ...
    if not cutplan_path.exists():
        ...
        console.print("Run 'videotool cutplan' first to generate a cut plan.")
        return None
