...
class TestOpenAITranscriptionProvider:
    ...
    def test_file_not_found_raises(self, monkeypatch, tmp_path, stub_module):
        monkeypatch.setenv("OPENAI_API_KEY", "test-key")
    ...
    def test_small_file_direct_api_call(self, monkeypatch, tmp_path, stub_module):
        ...
        mock_cls = mock.Mock()
        with stub_module("openai", OpenAI=mock_cls):
    ...
    def test_large_file_chunked(self, monkeypatch, tmp_path, stub_module):
        ...
        with stub_module("openai", OpenAI=mock.Mock()):
            with mock.patch("videotool.transcription._probe_duration", return_value=1200.0), \
    ...
    def test_timestamp_offset_applied_to_chunks(self, monkeypatch, tmp_path, stub_module):
    ...
    def test_chunk_failure_raises_with_chunk_number(self, monkeypatch, tmp_path, stub_module):
